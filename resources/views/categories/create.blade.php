<x-app-layout :title="'Tambah Kategori'">
    ...
    <div class="space-y-6 animate-fade-in-up">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-xl font-semibold text-stone-800">Tambah Kategori</h1>
                <p class="text-sm text-stone-500 mt-0.5">Buat kategori Packages layanan baru</p>
            </div>
        ...
        <div class="rounded-2xl border border-stone-200 bg-white shadow-sm">
            ...
            <div class="border-b border-slate-100 px-6 py-4">
                ...
                <p class="text-xs text-stone-400 mt-0.5">Lengkapi data kategori di bawah ini</p>
            </div>

            <form method="POST" action="{{ route('categories.store') }}" class="px-6 py-5 space-y-5">
                @csrf
